...
public class Recee extends AppCompatActivity implements ActionBar.TabListener {
    static String producttype,productname,pic_uri;
    /**
     * The {@link android.support.v4.view.PagerAdapter} that will provide
     * fragments for each of the sections. We use astoresubmit
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recee);
        ...
        mViewPager = (ViewPager) findViewById(R.id.ReceeTabs);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return "External Branding".toUpperCase(l);
                case 1:
                    return "Internal Branding".toUpperCase(l);
            }
            return null;
        }
    }
