...
//        appbar.setBackground(getResources().getDrawable(R.drawable.oppo));
        switch (Client)
        {
            ...
            case "maharajawhiteline":{
                appbar.setBackground(getResources().getDrawable(R.drawable.maharajawhiteline));
                break;
            }
        }
...
//        setSupportActionBar(toolbar);
        ...
        Spinner storestate = (Spinner) findViewById(R.id.clientstate2);
        Spinner storecity = (Spinner) findViewById(R.id.clientcity2);
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.submitclientcity);
