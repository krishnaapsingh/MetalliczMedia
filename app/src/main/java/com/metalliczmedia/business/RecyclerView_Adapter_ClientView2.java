...
/**
 * Created by Sarjit on 3/17/2016.
 */
public class RecyclerView_Adapter_ClientView2 extends RecyclerView.Adapter<RecyclerView_Adapter_ClientView2.MyViewHolder>{
    public static ArrayList<String> al=new ArrayList<>();
    public static ArrayList<Integer> al2=new ArrayList<>();
    private LayoutInflater inflater;
    private Context context;
    public RecyclerView_Adapter_ClientView2(Context context)  {
